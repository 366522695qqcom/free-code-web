      ...
      while (turnCount < maxTurns) {
        ...
        try {
          ...
          for await (const event of stream) {
            ...
            if (event.type === "content_block_stop") {
              ...
              if (currentToolUse) {
                ...
                currentContent.push(toolUseBlock);
                yield {
                  event: "tool_use",
                  data: JSON.stringify({
                    id: currentToolUse.id,
          ...
          if (finalMessage.stop_reason === "tool_use") {
            ...
            // Add tool results - in a real implementation these would come from tool execution
            // For now, emit tool_use events and break (tool execution will be added by Task 3)
