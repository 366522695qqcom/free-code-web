        ...
        <div className="mt-2 space-y-1 border-t border-border-subtle pt-2">
          ...
          {Object.entries(properties).map(([key, schema]) => (
            <div key={key} className="flex items-start gap-2 text-xs">
              <span className="font-mono text-accent-green">{key}</span>
              {schema.type && (
...
function ResourceItem({
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-border-subtle bg-base/50 px-3 py-2">
      <FileText className="size-3 shrink-0 text-accent-green" />
      <div className="min-w-0 flex-1">
      ...
      {resource.mimeType && (
        <span className="shrink-0 rounded bg-overlay px-1.5 py-0.5 text-[0.6rem] text-text-muted">
          {resource.mimeType}
        </span>
      )}
      <Button
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-border-subtle px-4 py-3">
        ...
        {server.error && (
          <div className="mt-2 flex items-start gap-2 rounded-md bg-accent-red/15/10 px-3 py-2 text-xs text-accent-red">
