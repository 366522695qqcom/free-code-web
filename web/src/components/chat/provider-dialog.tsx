...
import { ModelDialog, type ModelFormData } from "@/app/settings/providers/model-dialog";
...
export function ProviderDialog({ open, onOpenChange, onProvidersChange }: ProviderDialogProps) {
